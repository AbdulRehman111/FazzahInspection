...
import 'package:fazzah_inspector/pages/change_password.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text('Home'.tr),
            tileColor:
                Get.currentRoute == '/home' ? Colors.blueAccent[300] : null,
          ...
          ListTile(
            ...
            tileColor:
                Get.currentRoute == '/archive' ? Colors.blueAccent[300] : null,
          ...
          ListTile(
            ...
            title: Text('Inbox'.tr),
            tileColor:
                Get.currentRoute == '/inbox' ? Colors.blueAccent[300] : null,
          ...
          ListTile(
            ...
            title: Text('Login'.tr),
            tileColor:
                Get.currentRoute == '/login1' ? Colors.blueAccent[300] : null,
            selected: _selectedDestination == 2,
            onTap: () {
              // Get.back();
              Get.to((LoginPage));
...
final bottomAppBar = Container(
  child: BottomAppBar(
    ...
    notchMargin: 4, //notche margin between floating button and bottom appbar
    child: Row(
